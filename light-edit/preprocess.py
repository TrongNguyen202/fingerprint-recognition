...
img_list = sorted(glob.glob('archive/SOCOFing/Real/*.BMP'))
print(len(img_list))
...
np.savez('dataset/x_real.npz', imgs)
np.save('dataset/y_real.npy', labels)

plt.figure(figsize=(1, 1))
plt.title(labels[-1])
plt.imshow(imgs[-1], cmap='gray')
img_list = sorted(glob.glob('archive/SOCOFing/Altered/Altered-Easy/*.BMP'))
print(len(img_list))
...
np.savez('dataset/x_easy.npz', imgs)
np.save('dataset/y_easy.npy', labels)

plt.figure(figsize=(1, 1))
plt.title(labels[-1])
plt.imshow(imgs[-1], cmap='gray')
img_list = sorted(glob.glob('archive/SOCOFing/Altered/Altered-Medium/*.BMP'))
print(len(img_list))
...
np.savez('dataset/x_medium.npz', imgs)
np.save('dataset/y_medium.npy', labels)

plt.figure(figsize=(1, 1))
plt.title(labels[-1])
plt.imshow(imgs[-1], cmap='gray')
img_list = sorted(glob.glob('archive/SOCOFing/Altered/Altered-Hard/*.BMP'))
print(len(img_list))
...
np.savez('dataset/x_hard.npz', imgs)
